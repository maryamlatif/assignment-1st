...
export default function Educationpage() {
  return (
    <div className='bg-slate-200 pt-5 min-h-screen flex flex-col items-center rounded-lg shadow-md'>
      <h1 className='text-black text-3xl sm:text-4xl md:text-2xl font-serif font-bold mb-4 drop-shadow-md'>
        Education
      </h1>
      <p className='text-center p-5 m-4 max-w-3xl from-neutral-300 font-serif text-lg sm:text-xl sm:text-left'>
      ...
      <ul className='list-disc list-inside text-center sm:text-left font-semibold text-sky-900 text-lg sm:text-xl'>
        <li className='mb-3'>
          <span className='text-xl sm:text-2xl'>GIAIC</span>
          <br />
          IT Course (2024)
        </li>
        <li className='mb-3'>
          <span className='text-xl sm:text-2xl'>Govt Karachi University</span>
          <br />
          Bachelor&apos;s Degree (2019-2021)
        </li>
        <li className='mb-3'>
          <span className='text-xl sm:text-2xl'>S.M.B Fatimah Jinnah College</span>
          <br />
          Intermediate Studies in Arts (2017-2019)
        </li>
        <li className='mb-3'>
          <span className='text-xl sm:text-2xl'>GOVT Girls School</span>
          <br />
